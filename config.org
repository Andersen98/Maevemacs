...
* Quick install
#+BEGIN_SRC 
git clone https://github.com/Andersen98/Maevemacs ~/.emacs.d
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package dashboard
    ...
    (setq dashboard-startup-banner "~/.emacs.d/Aqua.png")
...
** SyncTeX
*** Description
SyncTeX is a method that enables synchronization between a TeX source file and the resulting PDF output. I use it with zathura, so make sure to install that on your system as well as SyncTex!
